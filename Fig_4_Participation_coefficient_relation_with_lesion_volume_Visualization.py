...
# Load dataset
annots = loadmat('data_for_seaborn.mat')
...
part_coeff =oneDArray(np.transpose(annots['parti_coeff'])) #Extract feature of participation coefficient from the loaded matrix
